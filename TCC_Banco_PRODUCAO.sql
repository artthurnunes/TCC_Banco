...
INSERT INTO `tb_exercicios` VALUES (1,'RETO',8),(2,'SUPRA',8),(3,'OBLIQUO',8),(4,'PEDALADA',8),(5,'COM PESO',8),(6,'NO BANCO DECLINADO',8),(7,'BICICLETA',7),(8,'ESTEIRA',7),(9,'CORDA',7),(10,'JUMP',7),(11,'STEP',7),(12,'ROSCA DIRETA',3),(13,'ROSCA ALTERNADA',3),(14,'SCOTTY BARRA W',3),(16,'CONCENTRADA',3),(17,'SCOTTY BARRA RETA',3),(18,'BICEPS CORDA',3),(19,'BICEPS CROSS UNILATERAL',3),(20,'ROSCA 21',3),(21,'TABATA',3),(22,'PULLEY FRENTE',2),(23,'PULLEY FRENTE MÃO INVERT',2),(24,'PULLEY COSTAS',2),(25,'REMADA BAIXA',2),(26,'CAVALINHO PEGADA FECHADA',2),(27,'CAVALINHO PEGADA MEIO',2),(28,'CAVALINHO PEGADA ABERTA',2),(29,'PULLEY TRAS COM CORPO',2),(30,'PULLEY FRENTE COM CORPO',2),(31,'PULLEY FRENTE COM CORPO INVERT',2),(32,'BARRA SOLTA ELEVAÇÃO FRONTAL',5),(33,'BARRA SOLTA ELEVAÇÃO TRAS',5),(35,'ELEVAÇÃO FRONTAL ',5),(36,'CRUSSIFIXO INVERTIDO CROSS',5),(37,'ELEVAÇÃO LATERAL',5),(38,'REMADA ALTA',5),(39,'SUPINO RETO BARRA',1),(40,'SUPINO RETO HALTER',1),(41,'SUPINO INCLINADO HALTER',1),(43,'SUPINO INCLINADO BARRA',1),(44,'SUPINO DECLINADO BARRA',1),(45,'SUPINO DECLINADO HALTER',1),(46,'CRUSSIFIXO CROSS',1),(47,'PECK DECK',1),(48,'PECK DECK INVERT',2),(49,'LEG RETO',6),(50,'LEG 45º',1),(51,'AGACHAMENTO APARELHO',6),(52,'AGACHAMENTO BARRA',6),(53,'AVANÇO NO SMITH',6),(54,'AVANÇO BARRA SOLTA',6),(55,'ADUTOR',6),(56,'ABDUTOR',6),(57,'MESA FLEXORA',6),(58,'MESA EXTENSORA',6),(59,'PANTURILHA BURRINHO',6),(60,'PANTURILHA LEG',6),(61,'GLUTEO COM CANELEIRAS',6),(62,'TRICEPS TESTA',4),(63,'TRÍCEPS TESTA UNILAT',4),(64,'TRICEPS CORDA',4),(65,'TRICEPS CROSS BARRA RETA',4),(66,'TRICEPS CROSS BARRA V',4),(67,'BANCO COM CORPO',4),(68,'BARRA RETA APOIADO NO SCOTTY',4),(69,'TRICEPS TESTA NO CROSS BARRA RETA',4),(70,'TRICEPS TESTA NO CROSS UNILA',4);
...
--
-- Dumping data for table `tb_fotos_alunos`
--

LOCK TABLES `tb_fotos_alunos` WRITE;
/*!40000 ALTER TABLE `tb_fotos_alunos` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_fotos_alunos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tb_membros` VALUES (8,'ABDDOMEN'),(7,'AERÓBICO'),(3,'BÍCEPS'),(2,'COSTAS'),(5,'OMBRO'),(1,'PEITO'),(6,'PERNA'),(4,'TRÍCEPS');
...
INSERT INTO `tb_modalidades` VALUES (2,'CROSS FIT'),(3,'FUNCIONAL'),(1,'MUSCULAÇÃO');
...
INSERT INTO `tb_planos_valores` VALUES (1,'Mensal',65),(2,'Trimestral',60),(3,'Semestral',50),(4,'Avulso',8);
...
INSERT INTO `tb_repeticoes` VALUES (7,'12x10x8x6'),(11,'1x'),(12,'1x_Fadigar'),(1,'3x10'),(3,'3x12'),(4,'3x15'),(13,'3x_Fadigar'),(2,'4x10'),(6,'4x6'),(5,'4x8'),(10,'5x6'),(8,'6x8x10x12'),(9,'Fadigar');
...
-- Dump completed on 2018-10-11 13:04:57
