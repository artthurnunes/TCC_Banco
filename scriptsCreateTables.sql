...
INSERT INTO TB_HISTORICO_PAGAMENTOS_ALUNOS (CD_REGISTRO,PROXIMO_VENCIMENTO,DT_PAGAMENTO,VALOR_PAGO)
VALUES (3,'2018/09/20',NULL,80);

UPDATE TB_HISTORICO_PAGAMENTOS_ALUNOS SET VALOR_PAGO = NULL WHERE CD_PAGAMENTO = 1;
