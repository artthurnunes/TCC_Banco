...
-- ------------------------------------------------------- SELECTS COM PROBLEMA NAS TELAS
-- SELECT ESTÁ TRAZENDO O VALOR DOS PLANOS REPETIDOS. SELECT PARA A TELA DE ALUNOS EM ATRASO. 
-- TENTAR FAZER IGUAL A QUE O MARCEL FEZ PARA A TELA DE MENSALIDADES.
SELECT 				A.CD_REGISTRO,A.NOME,A.TEL1, DATE_FORMAT(D.DT_ENTRADA,'%e/%m/%Y')
