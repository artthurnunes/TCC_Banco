...
SELECT A.CD_REGISTRO, A.NOME, B.PROXIMO_VENCIMENTO, C.VALOR FROM TB_ALUNOS A
...
WHERE NOME LIKE '%art%' ORDER BY A.NOME ASC,B.CD_PAGAMENTO DESC LIMIT 1;
...
UPDATE TB_HISTORICO_PAGAMENTOS_ALUNOS SET DT_PAGAMENTO = NULL,VALOR_PAGO = NULL WHERE CD_REGISTRO = 8 ORDER BY CD_PAGAMENTO DESC LIMIT 1;
